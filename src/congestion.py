...
if __name__ == '__main__':
    ...
    for p in ALL_PORTS:
        ...
        print('  %-15s' % p + ''.join(
            ...
            for i in range(1, 13)))
    print('\n  Every port dips Sep-Dec, which overlaps Bay of Bengal')
    print('  cyclone season. PortWatch reports arrivals, not causes, so')
    print('  that is an association worth planning around, not a proven')
